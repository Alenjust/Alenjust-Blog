    ...
    <div class="container">
            ...
            <div class="posts animated fadeIn">
                <div class="flex">
                    <div v-for="(article, index) in reducedArticles" class="oneArticle">
                        ...
                        <router-link :to="{name: 'article', params: {id: article.aid, index: index, page: 1}, hash: '#article'}" tag="button" exact><span>阅读</span></router-link>
                    </div>
                </div>
            </div>
        </section>
        <section class="contact">
            <a href="#contactMe" class="title animated bounceIn">
                <p class="headline" id="contactMe">联系我</p>
            </a>
...
export default {
    ...
    created () {
        this.set_headline({
            content: 'Welcome to Alenjust blog',
