<template>
    <div id="contact">
        <a href="#about_me" class="title animated bounceIn">
            <p class="headline" id="about_me">关于我</p>
        </a>
        <div class="info animated tada">
            <img src="../../../static/alenjust.jpg" alt="me"/>
            <div class="wraper">
                <p class="left">邮箱:</p><p class="right">chenalenjust@gmail.com</p>
                <p class="left">QQ:</p><p class="right">2501647360</p>
                <p class="left">学校:</p><p class="right">.....</p>
                <p class="left">在线简历:</p><a class="right" href="javaScript:void(0)">......</a>
            </div>
        </div>
    </div>
</template>
